...
export default function AchievementTimeline({
  ...
  const getAchievementIcon = (type: string) => {
    switch (type) {
      ...
      case "score_milestone_5000":
        return <Target className="h-5 w-5" />;
      case "score_milestone_6000":
        return <Medal className="h-5 w-5" />;
      case "score_milestone_7000":
        return <Award className="h-5 w-5" />;
      case "score_milestone_8000":
        return <Crown className="h-5 w-5" />;
      case "event_specialist":
        return <Trophy className="h-5 w-5" />;
      case "multi_event_master":
          ...
          {newAchievements.map((achievement) => (
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center space-x-3">
                  <div
                    className={`glass-icon-container w-12 h-12 flex items-center justify-center bg-gradient-to-br ${getAchievementColor(
                      achievement.type
            ...
            {achievements.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Start completing performances to unlock achievements!
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                {achievements.map((achievement, index) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center">
                      <div
                        className={`glass-icon-container w-10 h-10 flex items-center justify-center bg-gradient-to-br ${getAchievementColor(
                          achievement.type
                        )} border-current`}
                      >
                        {getAchievementIcon(achievement.type)}
